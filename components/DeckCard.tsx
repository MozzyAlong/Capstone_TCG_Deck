...
export default function DeckCard({ deck }: DeckCardProps) {
    ...
    return (
        <div className="rounded-2xl border border-white/10 bg-gray-800/40 shadow-xl backdrop-blur-md overflow-hidden">
            ...
            0 cards
                ...
                <div className="mt-4 flex justify-end gap-2">
                    ...
                    <button disabled className="rounded-lg px-3 py-2 text-sm font-semibold border border-white/10 bg-gray-900/30 text-gray-400 cursor-not-allowed">
                        Delete
                    </button>
                </div>
            </div>
